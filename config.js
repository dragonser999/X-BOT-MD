...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:de4d26d4665f903c3659eb0aa386c426";
const SUDO = process.env.SUDO || '918714418514';
...
const URL = process.env.URL || "https://www.instagram.com/___ansad_";
